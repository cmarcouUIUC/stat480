...
```
With only the significant covariates, the R^2 is 0.4471981. In comparison to the full model, there is a slight decrease in the R^2. 
```{r}
...
The lambda value that minimizes OOS deviance is 0.00137444. With that lambda, there are 974 non-zero coefficients. Using the 1se rule instead, there are only 811 non-zero coefficients.
(carrie I"m getting 
[1] 0.00137444
[1] 974
[1] 916
