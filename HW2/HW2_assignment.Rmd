...
The R^2 is .4565419 (.447301 charlie, I had a different result here). There are 40 coefficients. Of these 40 coefficients, we can see that 4 are not significant.
```{r}
