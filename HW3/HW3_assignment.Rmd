...
We can see that the R2 is 0.06938527, which is not very large, which indicates the fit is not very good. This means that little of the treatment effect of degree on getting a loan is explained by the controls. #Is that right? Is there anything else to say on this one?
