...
Based on both AIC and BIC, the optimal K is 5. This means that the simplest model was chosen. However, the R^2 for the model is low, .02987, indicating that only approximately 3% of the deviance in x is being explained.
